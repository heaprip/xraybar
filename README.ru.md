...
> Статус: ранний; автор пользуется им каждый день. Ещё не сделано:
...
Интерфейс следует языку системы: английский или русский.
...
| Diagnostics › | Лог, подробный лог, папка с данными, удаление помощника. Собственный лог XrayBar: Console.app, подсистема `io.github.heaprip.xraybar` |
